...
object LogTestFixtures {
    ...
    fun writeCommit(logStore: DeltaLogStore, tablePath: String, version: Long, actions: List<Action>) {
    ...
    fun protocol(minReader: Int = 1, minWriter: Int = 2): Protocol =
        Protocol(minReaderVersion = minReader, minWriterVersion = minWriter)
    ...
    val SIMPLE_SCHEMA: String = """{"type":"struct","fields":[""" +
